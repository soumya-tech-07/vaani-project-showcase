...
export function TextEffect({
  ...
  const segments = per === 'line' ? children.split(/\r?\n/) : per === 'word' ? children.split(/(\s+)/) : children.split('');
  ...
  const delayedContainerVariants: Variants = {
    ...
    visible: {
      ...
      transition: {
        ...
        staggerChildren: (containerVariants.visible as TargetAndTransition)?.transition?.staggerChildren || defaultStaggerTimes[per],
        delayChildren: delay,
      },
    },
